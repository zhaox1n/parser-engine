...
import org.github.zhaox1n.parser.segment.ddl.index.IndexSegment;
import org.github.zhaox1n.parser.segment.dml.column.ColumnSegment;
import org.github.zhaox1n.parser.segment.dml.expr.ExpressionSegment;
import org.github.zhaox1n.parser.segment.dml.expr.complex.CommonExpressionSegment;
import org.github.zhaox1n.parser.segment.dml.expr.simple.LiteralExpressionSegment;
import org.github.zhaox1n.parser.segment.dml.expr.simple.ParameterMarkerExpressionSegment;
import org.github.zhaox1n.parser.segment.dml.expr.subquery.SubqueryExpressionSegment;
import org.github.zhaox1n.parser.segment.dml.expr.subquery.SubquerySegment;
import org.github.zhaox1n.parser.segment.dml.item.AggregationDistinctProjectionSegment;
import org.github.zhaox1n.parser.segment.dml.item.AggregationProjectionSegment;
import org.github.zhaox1n.parser.segment.dml.item.ExpressionProjectionSegment;
import org.github.zhaox1n.parser.segment.dml.order.OrderBySegment;
import org.github.zhaox1n.parser.segment.dml.order.item.ColumnOrderByItemSegment;
import org.github.zhaox1n.parser.segment.dml.order.item.ExpressionOrderByItemSegment;
import org.github.zhaox1n.parser.segment.dml.order.item.IndexOrderByItemSegment;
import org.github.zhaox1n.parser.segment.dml.order.item.OrderByItemSegment;
import org.github.zhaox1n.parser.segment.dml.predicate.PredicateSegment;
import org.github.zhaox1n.parser.segment.dml.predicate.value.*;
import org.github.zhaox1n.parser.segment.generic.DataTypeLengthSegment;
import org.github.zhaox1n.parser.segment.generic.DataTypeSegment;
import org.github.zhaox1n.parser.segment.generic.OwnerSegment;
import org.github.zhaox1n.parser.segment.generic.database.DatabaseNameSegment;
import org.github.zhaox1n.parser.segment.generic.database.SimpleDatabaseSegment;
import org.github.zhaox1n.parser.segment.generic.table.SimpleTableSegment;
import org.github.zhaox1n.parser.segment.generic.table.TableNameSegment;
import org.github.zhaox1n.parser.statement.dml.SelectStatement;
...
import org.github.zhaox1n.parser.value.keyword.KeywordValue;
import org.github.zhaox1n.parser.value.literal.impl.BooleanLiteralValue;
import org.github.zhaox1n.parser.value.literal.impl.NumberLiteralValue;
...
public abstract class MySQLVisitor extends MySQLStatementBaseVisitor<ASTNode> {
    ...
    public final ASTNode visitSchemaName(final SchemaNameContext ctx) {
        SimpleDatabaseSegment result = new SimpleDatabaseSegment(new DatabaseNameSegment(ctx.getStart().getStartIndex(), ctx.getStop().getStopIndex(), (IdentifierValue) visit(ctx.identifier())));
